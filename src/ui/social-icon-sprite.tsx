/** Same-document sprite so `<use href="#…">` picks up `currentColor` from the visible `<svg>`. */
export function SocialIconSprite() {
  return (
    <svg
      ...
      <symbol id="bluesky-icon" viewBox="0 0 16 17">
        ...
        <defs>
          <clipPath id="bluesky-clip">
            <path fill="#fff" d="M.1.85h15.3v15.3H.1z" />
          </clipPath>
        </defs>
      </symbol>
